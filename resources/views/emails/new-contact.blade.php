...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body style="word-spacing:normal;">
      ...
      >Message sent by <span style="font-weight:500;">{{ $input_data['name'] }}</span></div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#000000;"
      >Name: <span style="font-weight:500;">{{ $input_data['name'] }}</span></div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#000000;"
      >Email address: <span style="font-weight:500;">{{ $input_data['email'] }}</span></div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#000000;"
      >Message: <span style="font-weight:500;">{{ $input_data['message'] }}</span></div>
