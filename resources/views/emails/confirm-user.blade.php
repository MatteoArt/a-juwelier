...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body style="word-spacing:normal;">
      ...
      >thank you for contacting us, we will evaluate your proposal and contact you as soon as possible.</div>
      ...
      >Your watch: 
                    @if ($data['informations'][0])
                    <span style="font-weight:500;">{{ $data['informations'][0] }}</span>
                    @endif
                    @if ($data['informations'][1])
                    <span style="font-weight:500;">{{ $data['informations'][1] }}</span>
                    @endif
                    @if ($data['informations'][2])
                    <span style="font-weight:500;">{{ $data['informations'][2] }}</span>
                    @endif</div>
